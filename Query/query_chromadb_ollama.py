...
def main():
    """
    The app will run a LangChain that will identify similarity results for a query.
    The answer will be provided to the user after sending the matching docs to Ollama, Llama3 model
    """
    ...
    # define the LLM used - Ollama, llama3
